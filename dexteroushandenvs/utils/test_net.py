...
from utils.pn_backbone import PointNetBackbone, TransPointNetBackbone
...
class NetworkBuilder:
    ...
    class BaseNetwork(nn.Module):
        ...
        def _build_cnn2d(
            self, input_shape, convs, activation, conv_func=torch.nn.Conv2d, norm_func_name=None
        ):
...
class A2CPCBuilder(NetworkBuilder):
    def __init__(self, **kwargs):
    ...
    class Network(NetworkBuilder.BaseNetwork):
        def __init__(self, params, **kwargs):
            ...
            self.pn_backbone = PointNetBackbone(pc_dim=8, feature_dim=128)
    ...
    def build(self, name, **kwargs):
        net = A2CPCBuilder.Network(self.params, **kwargs)
        return net
