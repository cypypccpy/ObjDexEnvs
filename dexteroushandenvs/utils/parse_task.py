...
from tasks.shadow_hand_free_visualization import ShadowHandFreeVisualization
from tasks.shadow_hand_free_with_physics import ShadowHandFreeWithPhysics
...
def parse_task(args, cfg, cfg_train, sim_params, agent_index):
    ...
    elif args.task_type == "MBRL":
        print("Task type: MBRL")
