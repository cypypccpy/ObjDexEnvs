...
class Config:
    ...
    def _file2dict(filename, use_predefined_variables=True):
        ...
        with tempfile.TemporaryDirectory() as temp_config_dir:
            ...
            if filename.endswith('.py'):
                ...
                import utils.pn_utils.maniskill_learn
                cfg_dict = utils.pn_backbone.maniskill_learn.load(temp_config_file.name)
            # close temp file
            temp_config_file.close()
    ...
    def dump(self, file=None):
        ...
        if self.filename.endswith('.py'):
            ...
            from utils.pn_utils.maniskill_learn.utils.fileio import dump
            if file is None:
